...
@Test 
	...
	public void exportContent_TC_DSMod_10() throws InterruptedException, FileNotFoundException, IOException {
		...
		logger = extent.createTest("exportContent_TC_DSMod_10");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(TC_DSMod_10): Verify Download button functionality when Move in Ready Content type is selected.",ExtentColor.BLUE));
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to select 'Move In Ready' radio button.",ExtentColor.GREEN)); 
		...
		WebElement westerlyatDelaneyParkCheckbox = driver.findElement(By.xpath("//input[@value='26202']"));
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Westerly at Delaney Park Checkbox'.",ExtentColor.GREEN)); 
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Download' button.Hence Download functionality is working fine for Move In Ready.",ExtentColor.GREEN)); 
		Thread.sleep(8000);
