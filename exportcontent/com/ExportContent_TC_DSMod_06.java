...
@Test 
	...
	public void ExportContent_TC_DSMod_06() throws InterruptedException {
		...
		logger = extent.createTest("exportContent_TC_DSMod_06");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(TC_DSMod_06): Verify Check All button functionality.",ExtentColor.BLUE)); 
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Check All' button.All the communities are selected.Hence Check All functionality is working fine.",ExtentColor.GREEN)); 
		Thread.sleep(4000);
