...
@Test 
	...
	public void exportContent_TC_DSMod_08() throws InterruptedException, FileNotFoundException, IOException {
		...
		logger = extent.createTest("exportContent_TC_DSMod_08");
		logger.log(Status.INFO,MarkupHelper.createLabel("TestCase(TC_DSMod_08): Verify Download button functionality when Floor Plan Content type is selected.",ExtentColor.BLUE));
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Download' button.Hence Download functionality is working fine for Region.",ExtentColor.GREEN)); 
