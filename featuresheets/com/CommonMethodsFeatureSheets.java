...
public class CommonMethodsFeatureSheets {
	...
	public static WebDriver OpenBrowser(WebDriver driver, String brName,
		...
		// open url
		driver.get("https://kbho01mstriq361inte.dxcloud.episerver.net/util/login?ReturnUrl=%2Fepiserver%2Fcms");
	...
	public static HashMap<String, String> readDataFromTC(String tcID)
		...
		String flPath = "C:\\Data\\Data_CMS_FeatureSheets.xls";
