...
public class CopyOfLoginToKBNew {
...
@Test 
	public void KBHomeLoginPage() throws InterruptedException {
		...
		logger = extent.createTest("KBHomeLoginPageTesting");
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Log in with Email with FAIL Status",ExtentColor.GREEN)); // send the passed information to the report with GREEN color highlighted
		...
		logger.log(Status.PASS,MarkupHelper.createLabel("User is able to click on 'Log out' with PASS Status",ExtentColor.GREEN)); // send the passed information to the report with GREEN color highlighted
		Thread.sleep(2000);
